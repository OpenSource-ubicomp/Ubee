...
const double TICKS_PER_REVOLUTION = 730; // For reference purposes.
const double WHEEL_RADIUS = 0.136; // Wheel radius in meters
const double WHEEL_BASE = 0.50; // Center of left tire to center of right tire
